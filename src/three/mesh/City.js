...
import FlyLineShader from './FlyLineShader_c.ts';
import MeshLine from './MeshLine';
// import LightWall from './LightWall';
import LightWall from './LightWall_c.ts';
// import LightRadar from './LightRadar';
import LightRadar from './LightRadar_c.ts';
// import AlarmSprite from './AlarmSprite';
import AlarmSprite from './AlarmSprite_c.ts';
...
export default function createCity() {
  ...
  gltfLoader.load('./model/city.glb', gltf => {
    ...
    alarmSprite.onClick(function (ev) {
